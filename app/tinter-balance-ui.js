Tinter.ensureBalance=function(){
  ...
  if(!document.querySelector('#tinterBalance'))stage.insertAdjacentHTML('afterend','<div id="tinterBalance" class="tinter-balance"><div class="tinter-balance-top"><b>Balance the camera</b><button type="button" id="tinterAutoTemp" class="secondary">Auto Temp</button></div><p class="tinter-balance-note"><b>Before swiping:</b> point the camera at a white wall or hold white paper near your face, then press Auto Temp.</p><div class="tinter-balance-grid"><label>Warmth<input type="range" id="tinterWarmth" min="-100" max="100" value="0"></label><label>Tint<input type="range" id="tinterTint" min="-100" max="100" value="0"></label></div><p id="tinterBalanceNote" class="tinter-balance-note">Fine tune until white looks white, not yellow, blue, green, or pink.</p></div>');
